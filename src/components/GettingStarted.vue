...
check out <a @click="$router.push('/props')" class="hreffss"><strong><em>props</em></strong></a> for properites</p>
<p>NOTE : <ins>you have to load the icons separately</ins> like loading material-icons files with cdn</p>
