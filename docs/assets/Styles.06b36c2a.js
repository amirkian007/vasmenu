import{_ as s,c as a,o as n,a as p}from"./index.4e03738f.js";const l={},c={class:"markdown-body"},e=p(`<h2><a id="user-content-styling" class="anchor" aria-hidden="true" href="#styling"><span aria-hidden="true" class="octicon octicon-link"></span></a>Styling</h2><h3><a id="user-content-sass-varibles" class="anchor" aria-hidden="true" href="#sass-varibles"><span aria-hidden="true" class="octicon octicon-link"></span></a>Sass varibles</h3><p>to use sass varibles import the sass file insted of css, then import custom varibles. example:</p><div class="highlight highlight-source-css-scss"><pre><span class="pl-c"><span class="pl-c">//</span>style.scss</span>
