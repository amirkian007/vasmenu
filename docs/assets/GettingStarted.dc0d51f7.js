import{_ as s,c as a,o as p,a as n}from"./index.06586bb0.js";const l={},c={class:"markdown-body"},o=n(`<h1><a id="user-content-basic-usage" class="anchor" aria-hidden="true" href="#basic-usage"><span aria-hidden="true" class="octicon octicon-link"></span></a>Basic Usage</h1><p>a simple example would be like this : check out <a href="#props"><strong><em>props</em></strong></a> for properites</p><div class="highlight highlight-text-html-basic"><pre><span class="pl-kos">&lt;</span><span class="pl-ent">template</span><span class="pl-kos">&gt;</span>
